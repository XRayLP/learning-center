...
$GLOBALS['TL_LANG']['tl_member_group']['courseName'][0] = 'Kursname';
$GLOBALS['TL_LANG']['tl_member_group']['courseName'][1] = 'Name des Kurses, z.B: Mathematik';
$GLOBALS['TL_LANG']['tl_member_group']['courseNumber'][0] = 'Kursnummer';
$GLOBALS['TL_LANG']['tl_member_group']['courseNumber'][1] = 'Nummer des Kurses, z.B: 11/2';
$GLOBALS['TL_LANG']['tl_member_group']['projectName'][0] = 'Projektname';
$GLOBALS['TL_LANG']['tl_member_group']['projectName'][1] = 'Name des Projektes';
$GLOBALS['TL_LANG']['tl_member_group']['projectDescription'][0] = 'Projektbeschreibung';
$GLOBALS['TL_LANG']['tl_member_group']['projectDescription'][1] = 'Eine kurze Beschreibung deines Projektes.';